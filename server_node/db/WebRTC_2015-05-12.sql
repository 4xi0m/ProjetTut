...
# Temps de génération: 2015-05-12 13:47:40 +0000
# ************************************************************
...
CREATE TABLE `User` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=123483 DEFAULT CHARSET=latin1;
...
VALUES
	('a@b.c','a','b',2,X'31323334353600000000000000000000','2015-05-12 00:00:00');
